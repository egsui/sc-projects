...
# Milestone 1
# This function is to add data in dictionary and
# sort them in certain type as {name:{year:rank}}.
def add_data_for_name(name_data, year, rank, name):
    if name in name_data:                 # This name has already in dict of 'name_data'.
        if year in name_data[name]:         # This name has already been added in this year.
            # If same name in both girls and boys ranking in same year,
            # keep the rank of the higher one.
